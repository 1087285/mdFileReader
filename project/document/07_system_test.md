...
| 参照元 | `project/document/01_requirements.md` v1.1.0, `project/document/06_integration_test.md` v1.1.0 |
...
| 確認済み要件 | 証跡 |
|------------|------|
| REQ-PROC-01〜10, REQ-PROC-04a, REQ-PROC-12 | pytest 45 件 PASS |
...
| ACC-OK-01〕13 | 正常系受入テスト全件（Shift-JIS 保存対応含む） |
...
| 2 | pytest 自動テスト 45 件が全 PASS している | ✅ 確認済み（§6.1） |
